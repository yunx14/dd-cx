var Map = {
  ...
  providerMap: function() {
    ...
    Map.markerCluster = new MarkerClusterer(Map.map, Map.markers, {gridSize: 30, maxZoom: 10, imagePath: "https://developers.google.com/maps/documentation/javascript/examples/markerclusterer/m"});
