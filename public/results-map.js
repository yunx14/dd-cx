var Map = {
  ...
  providerMap: function() {
    ...
    Map.markerCluster = new MarkerClusterer(Map.map, Map.markers, {gridSize: 20, maxZoom: 17, imagePath: "https://developers.google.com/maps/documentation/javascript/examples/markerclusterer/m"});
